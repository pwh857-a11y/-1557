...
<br>
<BR><center>[$zname성으로부터 성벽파괴가 가능한 거리]<BR>
$t_mes
<center>
...
<font color="white" face="돋움"><span style="font-size:9pt;">성벽을 파괴해 수비대의 숫자를 줄입니다.<br>사용자의 지력에 의해 데미지와 확률이 결정됩니다.</font></span></font></td>
